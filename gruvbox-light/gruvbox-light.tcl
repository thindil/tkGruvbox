# gruvbox-light.tcl --
#
# gruvbox-light pixmap theme for the ttk package.
#
#  Copyright (c) 2021 Bartek Jasicki

package require Tk 8.6.0

namespace eval ttk::theme::gruvbox-light {

    variable version 0.1
    package provide ttk::theme::gruvbox-light $version
    ...
    LoadImages [file join [file dirname [info script]] gruvbox-light]

    ttk::style theme create gruvbox-light -parent default -settings {
        ttk::style configure . \
       ...
       ttk::style element create Notebook.client \
        ...
        # And at the moment there are no lines as in the Gruvbox theme
        ...
        # Treeview
        ttk::style configure Treeview -background #ebdbb2
