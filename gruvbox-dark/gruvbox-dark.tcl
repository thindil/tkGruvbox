# gruvbox-dark.tcl --
#
# gruvbox-dark pixmap theme for the ttk package.
#
#  Copyright (c) 2021 Bartek Jasicki

package require Tk 8.6.0

namespace eval ttk::theme::gruvbox-dark {

    variable version 0.1
    package provide ttk::theme::gruvbox-dark $version
    ...
    LoadImages [file join [file dirname [info script]] gruvbox-dark]

    ttk::style theme create gruvbox-dark -parent default -settings {
        ttk::style configure . \
